...
const en = {
  ...
  subscription: {
    ...
    chains: 'USDC test chains',
    createPlans: '1. Prepare plans',
    createSubscription: '2. Create subscription',
    createPortal: '3. Create portal session',
    payInvoice: '4. Open invoice checkout',
    waitPaid: '5. Check payment status',
    upgrade: '6. Upgrade to Pro',
    reset: 'Reset',
    restore: 'Restore',
    ...
    popupBlocked: 'The popup was blocked. Redirecting this tab to Checkout.',
    unknownError: 'unknown error',
  },
